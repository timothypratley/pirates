...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19044__auto__,writer__19045__auto__,opt__19046__auto__){
return cljs.core._write.call(null,writer__19045__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18438__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18438__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18438__auto__)){
return or__18438__auto__;
} else {
...
var G__40123 = o;
(G__40123[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__40124__delegate = function (args){
...
while (G__40125__i < G__40125__a.length) {G__40125__a[G__40125__i] = arguments[G__40125__i + 0]; ++G__40125__i;}
  args = new cljs.core.IndexedSeq(G__40125__a,0);
} 
return G__40124__delegate.call(this,args);};
...
return G__40124__delegate(args);
});
...
var old_40127 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_40127))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_40127)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18426__auto__ = (node === document.activeElement);
if(and__18426__auto__){
var and__18426__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18426__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__40130 = jsprops;
(G__40130["defaultValue"] = value);

(G__40130["onChange"] = ((function (G__40130,v,value,on_change){
return (function (p1__40128_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__40128_SHARP_);
});})(G__40130,v,value,on_change))
);
...
var vec__40132 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__40132,(0),null);
var id = cljs.core.nth.call(null,vec__40132,(1),null);
var class$ = cljs.core.nth.call(null,vec__40132,(2),null);
...
var temp__4659__auto__ = (function (){var G__40136 = cljs.core.meta.call(null,v);
if((G__40136 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__40136);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__40138_40139 = v;
var G__40138_40140__$1 = (((G__40138_40139 == null))?null:reagent.impl.template.key_from_vec.call(null,G__40138_40139));
if((G__40138_40140__$1 == null)){
} else {
(jsprops["key"] = G__40138_40140__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__40143 = cljs.core.meta.call(null,argv);
if((G__40143 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__40143);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__40144 = (((jsprops == null))?{}:jsprops);
(G__40144["key"] = key);
...
var G__40145 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__40145;
continue;
}
} else {
...
var n__19352__auto___40146 = a.length;
var i_40147 = (0);
while(true){
if((i_40147 < n__19352__auto___40146)){
(a[i_40147] = reagent.impl.template.as_element.call(null,(a[i_40147])));
...
var a = cljs.core.into_array.call(null,s);
var n__19352__auto___40149 = a.length;
var i_40150 = (0);
while(true){
if((i_40150 < n__19352__auto___40149)){
var val_40151 = (a[i_40150]);
if((cljs.core.vector_QMARK_.call(null,val_40151)) && ((reagent.impl.template.key_from_vec.call(null,val_40151) == null))){
(o["no-key"] = true);
} else {
}

(a[i_40150] = reagent.impl.template.as_element.call(null,val_40151));

var G__40152 = (i_40150 + (1));
i_40150 = G__40152;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18426__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18426__auto__){
return (ctx["no-key"]);
} else {
return and__18426__auto__;
...
var G__40154 = (cljs.core.count.call(null,argv) - first_child);
switch (G__40154) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__40154){
...
//# sourceMappingURL=template.js.map?rel=1458781545422