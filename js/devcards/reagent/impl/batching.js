...
var or__18438__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18438__auto__)){
return or__18438__auto__;
} else {
var or__18438__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18438__auto____$1)){
return or__18438__auto____$1;
} else {
var or__18438__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18438__auto____$2)){
return or__18438__auto____$2;
} else {
var or__18438__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__19352__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19352__auto__)){
var c_40059 = (a[i]);
if(cljs.core.truth_((c_40059["cljsIsDirty"]))){
(c_40059["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19044__auto__,writer__19045__auto__,opt__19046__auto__){
return cljs.core._write.call(null,writer__19045__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__40063 = c;
var G__40063__$1 = (((G__40063 == null))?null:(G__40063["props"]));
if((G__40063__$1 == null)){
return null;
} else {
return (G__40063__$1["argv"]);
}
});
...
var G__40065_40066 = (c["cljsRatom"]);
if((G__40065_40066 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__40065_40066);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1458781545120