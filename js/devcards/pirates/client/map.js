...
var G__83355 = (new THREE.WebGLRenderer({"antialias": true, "canvas": element}));
G__83355.setPixelRatio(window.devicePixelRatio);
...
var camera = (function (){var G__83360 = (new THREE.PerspectiveCamera((75),(2),0.1,(1000)));
G__83360.position.set((0),(5),(10));

G__83360.lookAt((new THREE.Vector3((0),(0),(0))));
...
var ship = (function (){var G__83361 = pirates.client.scene.make_ship.call(null,scene,new cljs.core.Keyword(null,"uid","uid",-1447769400).cljs$core$IFn$_invoke$arity$2(cljs.core.deref.call(null,app_state),"Unknown"));
G__83361.add(camera);
...
var temp__4657__auto___83364 = cljs.core.get_in.call(null,cljs.core.deref.call(null,app_state__$1),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"camera","camera",-1190348585),new cljs.core.Keyword(null,"position","position",-2011731912)], null));
if(cljs.core.truth_(temp__4657__auto___83364)){
var vec__83363_83365 = temp__4657__auto___83364;
var x_83366 = cljs.core.nth.call(null,vec__83363_83365,(0),null);
var y_83367 = cljs.core.nth.call(null,vec__83363_83365,(1),null);
var z_83368 = cljs.core.nth.call(null,vec__83363_83365,(2),null);
camera.position.set(x_83366,y_83367,z_83368);
} else {
}
...
//# sourceMappingURL=map.js.map?rel=1459053684486