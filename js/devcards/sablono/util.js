...
var x__19101__auto__ = (((x == null))?null:x);
var m__19102__auto__ = (sablono.util.to_str[goog.typeOf(x__19101__auto__)]);
if(!((m__19102__auto__ == null))){
return m__19102__auto__.call(null,x);
} else {
var m__19102__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19102__auto____$1 == null))){
return m__19102__auto____$1.call(null,x);
} else {
...
var x__19101__auto__ = (((x == null))?null:x);
var m__19102__auto__ = (sablono.util.to_uri[goog.typeOf(x__19101__auto__)]);
if(!((m__19102__auto__ == null))){
return m__19102__auto__.call(null,x);
} else {
var m__19102__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19102__auto____$1 == null))){
return m__19102__auto____$1.call(null,x);
} else {
...
var len__19507__auto___38485 = arguments.length;
var i__19508__auto___38486 = (0);
while(true){
if((i__19508__auto___38486 < len__19507__auto___38485)){
args__19514__auto__.push((arguments[i__19508__auto___38486]));

var G__38487 = (i__19508__auto___38486 + (1));
i__19508__auto___38486 = G__38487;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19515__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq38484){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38484));
});
/**
...
var vec__38489 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__38489,(0),null);
var words = cljs.core.nthnext.call(null,vec__38489,(1));
...
var G__38491 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__38491,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__38491;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18438__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1458781542768