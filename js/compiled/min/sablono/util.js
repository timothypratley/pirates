...
var len__7279__auto___31456 = arguments.length;
var i__7280__auto___31457 = (0);
while(true){
if((i__7280__auto___31457 < len__7279__auto___31456)){
args__7286__auto__.push((arguments[i__7280__auto___31457]));

var G__31458 = (i__7280__auto___31457 + (1));
i__7280__auto___31457 = G__31458;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31455){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31455));
});
/**
...
var vec__31460 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__31460,(0),null);
var words = cljs.core.nthnext.call(null,vec__31460,(1));
...
var G__31462 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__31462,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__31462;
}
} else {
