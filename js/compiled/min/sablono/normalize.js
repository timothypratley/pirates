...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__31465_SHARP_){
return ((p1__31465_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__31465_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__31467,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__31467;
}
});
...
var len__7279__auto___31471 = arguments.length;
var i__7280__auto___31472 = (0);
while(true){
if((i__7280__auto___31472 < len__7279__auto___31471)){
args__7286__auto__.push((arguments[i__7280__auto___31472]));

var G__31473 = (i__7280__auto___31472 + (1));
i__7280__auto___31472 = G__31473;
continue;
} else {
}
break;
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__31468_SHARP_);
});})(maps__$1))
...
var G__31470 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__31470,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__31470;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq31469){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31469));
});
/**
...
var vec__31477 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__31477,(0),null);
var names = cljs.core.nth.call(null,vec__31477,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31477,tag_name,names){
return (function (p1__31474_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__31474_SHARP_));
});})(matches,vec__31477,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31477,tag_name,names){
return (function (p1__31475_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__31475_SHARP_));
});})(matches,vec__31477,tag_name,names))
,names)))], null);
});
/**
...
var vec__31481 = p__31478;
var tag = cljs.core.nth.call(null,vec__31481,(0),null);
var content = cljs.core.nthnext.call(null,vec__31481,(1));
...
var vec__31482 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__31482,(0),null);
var id = cljs.core.nth.call(null,vec__31482,(1),null);
var class$ = cljs.core.nth.call(null,vec__31482,(2),null);
