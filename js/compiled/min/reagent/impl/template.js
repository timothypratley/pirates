...
var G__33819 = o;
(G__33819[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__33821__i < G__33821__a.length) {G__33821__a[G__33821__i] = arguments[G__33821__i + 0]; ++G__33821__i;}
  args = new cljs.core.IndexedSeq(G__33821__a,0);
} 
...
var old_33823 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_33823))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_33823)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__6198__auto__ = (node === document.activeElement);
if(and__6198__auto__){
var and__6198__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
var G__33826 = jsprops;
(G__33826["defaultValue"] = value);

(G__33826["onChange"] = ((function (G__33826,v,value,on_change){
return (function (p1__33824_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33824_SHARP_);
});})(G__33826,v,value,on_change))
);
...
var vec__33828 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33828,(0),null);
var id = cljs.core.nth.call(null,vec__33828,(1),null);
var class$ = cljs.core.nth.call(null,vec__33828,(2),null);
...
var temp__4659__auto__ = (function (){var G__33832 = cljs.core.meta.call(null,v);
if((G__33832 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__33832);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__33834_33835 = v;
var G__33834_33836__$1 = (((G__33834_33835 == null))?null:reagent.impl.template.key_from_vec.call(null,G__33834_33835));
if((G__33834_33836__$1 == null)){
} else {
(jsprops["key"] = G__33834_33836__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__33839 = cljs.core.meta.call(null,argv);
if((G__33839 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__33839);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__33840 = (((jsprops == null))?{}:jsprops);
(G__33840["key"] = key);
...
var G__33841 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33841;
continue;
}
} else {
...
var n__7124__auto___33842 = a.length;
var i_33843 = (0);
while(true){
if((i_33843 < n__7124__auto___33842)){
(a[i_33843] = reagent.impl.template.as_element.call(null,(a[i_33843])));
...
var a = cljs.core.into_array.call(null,s);
var n__7124__auto___33845 = a.length;
var i_33846 = (0);
while(true){
if((i_33846 < n__7124__auto___33845)){
var val_33847 = (a[i_33846]);
if((cljs.core.vector_QMARK_.call(null,val_33847)) && ((reagent.impl.template.key_from_vec.call(null,val_33847) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33846] = reagent.impl.template.as_element.call(null,val_33847));

var G__33848 = (i_33846 + (1));
i_33846 = G__33848;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__6198__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__6198__auto__){
return (ctx["no-key"]);
} else {
return and__6198__auto__;
...
var G__33850 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33850) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33850){
